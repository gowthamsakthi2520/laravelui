...
<!-- The Modal -->
<div class="modal" id="gallery_popup">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" id="add_gallery" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
...
<!-- view model -->
<div class="modal fade" id="galleryview_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <span class="galleryview_content">
...
<div class="modal" id="edit_sub_service_popup">
    ...
    <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">
                <form class="row g-3" id="edit_gallery" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
            ...
            "columnDefs": [{
                ...
                },
                {
                    ...
                    "render": function (data, type, row, meta) {
                        return '<p class="mb-0 customer-name fw-bold"></p>';
                    }
                },
                {
                    "targets": 2,
                    ...
                    "render": function (data, type, row, meta) {
                        ...
                        return '<p class="mb-0 customer-name"></p>';
